...
$tags="webgl html javascript";
$excerpt="Simple paint tool made using canvas and JavaScript";
$entry_date = date('c');
  ...
  <main id="post-page">
    <article id='blog-post' class='m-auto'>
      ...
      <div id="content-container" class="bg-faded">
        ...
        <p>A paint program I made for a class in 2015. You can use layers, transparency, and different drawing tools. I recently added undo/redo support, and now you can even export your drawing once finished!</p>
        <p><a class="badge badge-info" href="../projects/drawing-web-app/">Make a masterpiece!</a></p>
        <hr/>
      </div>
